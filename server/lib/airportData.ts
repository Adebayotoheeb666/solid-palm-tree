...
export const MAJOR_AIRPORTS: AirportInfo[] = [
  ...
  { code: "STN", name: "Stansted Airport", city: "London", country: "United Kingdom", region: "Europe" },
 ...
 */
export function searchAirports(keyword: string, limit: number = 10): AirportInfo[] {
...
export function getAirportByCode(code: string): AirportInfo | undefined {
  return MAJOR_AIRPORTS.find(airport => 
 ...
 */
export function getAirportsByRegion(region: string, limit: number = 20): AirportInfo[] {

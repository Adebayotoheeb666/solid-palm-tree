      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-36 py-8">
        <section className="bg-white/90 rounded-3xl p-8 lg:p-12 shadow-lg">
          ...
          <div className="text-[#23235B] text-lg lg:text-xl font-semibold leading-relaxed space-y-6">
            <div>
              <h2 className="font-semibold text-[#637996] underline decoration-auto mb-4">
                Terms and Conditions
              </h2>
              <p>
                These Terms and Conditions constitute a legally binding
                agreement made between you, whether individually or on behalf of
                any entity ("you", the "User"), and FGRМ Tech Pte. Ltd., a
                company incorporated in Singapore and located at 160 Robinson
                Road #14-04, Singapore 068914 ("Onboardticket.com", "we", "us",
                "our"), regarding your access to and use of the
                Onboardticket.com website (
                <a
                  href="https://Onboardticket.com"
                  className="underline text-[#637996]"
                >
                  https://Onboardticket.com
                </a>
                ) and related services (collectively, the "Site").
              </p>
              <p>
                The Site provides a service involving the direct or indirect
                sale, resale, and facilitation of airline ticket reservations
                (the "Service"). By using our Site and/or Service, you
                acknowledge that you have read, understood, and agree to be
                bound by these Terms and Conditions. If you do not agree, you
                must not use the Site or Service.
              </p>
              <p>
                We may revise these Terms and Conditions at any time. Your
                continued use of the Site and Service constitutes your
                acceptance of any changes.
              </p>
            </div>

            <div>
              <h3 className="font-semibold text-[#637996] mb-3">
                1. General Conditions
              </h3>
              <div className="space-y-2 ml-4">
                <p>
                  1.1. You agree to use the Site and Services legally and in
                  compliance with these Terms and Conditions.
                </p>
                <p>
                  1.2. If you do not agree to these Terms, you must cease use
                  immediately.
                </p>
                <p>
                  1.3. The Site operates in English. We are not responsible for
                  misunderstandings due to language.
                </p>
                <p>1.4. Additional policies include: Privacy Policy</p>
                <p>
                  1.5. Onboardticket.com operates under Singapore law. We do not
                  guarantee our Service or Site is appropriate outside
                  Singapore.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <ul className="ml-4 space-y-1">
                  ...
                  <li>
                    • Using the Service to support visa applications without
                    travel plans;
                  </li>
                  <li>• Creating speculative or fraudulent reservations.</li>
                </ul>
                <p>
                  3.3. You must be at least 16 years old to use our Site and
                  Services.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 ml-4">
                <p>
                  5.1. The Site and Service are provided "as is" without
                  warranties.
                </p>
                <p>
                  5.2. We do not guarantee uninterrupted or error-free access.
                </p>
                <p>
                  5.3. We are not liable for third-party behavior or site links.
                </p>
                <p>
                  5.4. No e-ticket numbers are issued unless explicitly stated
            ...
            <div>
              ...
              <p>
                We or our licensors own all intellectual property on the Site.
                No part of the Site may be copied, distributed, or modified
            ...
            <div>
              ...
              <div className="space-y-2 ml-4">
                <p>
                  7.1. Information on the Site may be outdated or incorrect.
                </p>
                <p>
                  7.2. We do not guarantee ticket issuance without proper
                  payment and confirmation.
                </p>
                <p>
                  7.3. "Receive Later" option requires activation at least 6
                  days before the itinerary start.
                </p>
                <p>
                  7.4. Prices may change without notice. We may suspend or
                  discontinue any Service.
                </p>
                <p>
                  7.5. Availability is not guaranteed and we reserve the right
                  to limit or deny service at our discretion.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 ml-4">
                <p>
                  8.1. Nothing in these Terms excludes liability for death,
                  personal injury, or fraud.
                </p>
                <p>
                  8.2. We are not liable for any damages including indirect or
                  consequential losses from use of the Site or Service.
                </p>
                <p>
                  8.3. Use of a PNR code does not guarantee visa or travel
                  approval. Use at your own risk.
                </p>
                <p>
                  8.4. Maximum liability shall not exceed the amount paid by you
                  for the Service.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p>
                You agree to indemnify Onboardticket.com from any claim,
                liability, or legal fee arising from your use of the Site or
            ...
            <div>
              ...
              <p>
                We may terminate your access at any time without notice. Upon
                termination, you must cease use and destroy any downloaded
                material.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 ml-4">
                <p>
                  11.1. Any complaints must be submitted via email and will be
                  reviewed within 30 days.
                </p>
                <p>
                  11.2. False claims will result in full indemnification of
                  Onboardticket.com.
                </p>
                <p>
                  11.3. Communications will be made via the email address you
                  provided.
                </p>
                <p>11.4. These Terms are governed by the laws of Singapore.</p>
                <p>
                  11.5. This document constitutes the entire agreement between
                  you and us.
                </p>
                <p>
                  11.6. If any provision is found invalid, the rest remain
                  enforceable.
                </p>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <ul className="ml-4 space-y-1">
                  <li>
                    • Duplicate payment was made due to technical error; or
                  </li>
                  <li>• Onboardticket.com failed to deliver the Service.</li>
                </ul>
                <p>
                  Refunds are issued within 30 days of a successful request.
                </p>
